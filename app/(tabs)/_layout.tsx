      ...
      <SafeAreaView style={sp.safe} edges={['top', 'bottom']}>
        <Animated.View style={[sp.card, { transform: [{ scale }] }]}>
          ...
          <View style={sp.authorRow}>
            <View style={sp.photoRing} accessibilityLabel="Author photo">
              <View style={sp.photoFill}>
                <Ionicons name="person" size={30} color="#cc6600" />
              </View>
            </View>
...
const sp = StyleSheet.create({
  ...
  photoRing: { width: 68, height: 68, borderRadius: 34, borderWidth: 2, borderColor: '#cc6600', padding: 3 },
  photoFill: { flex: 1, borderRadius: 31, backgroundColor: '#1a2a1a', justifyContent: 'center', alignItems: 'center' },
  authorInfo: { flex: 1 },
